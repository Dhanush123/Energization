...
public class ResultsActivity extends AppCompatActivity implements MediaPlayer.OnErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setsShow = (TextView) findViewById(R.id.setsCompleteText);
        ...
        numSets = (mSharedPreference.getInt("numSets", 1));

        setsShow.setText(setsShow.getText().toString()+" "+numSets);
